...
import { messageChannel, redisClient } from '../index.js';
...
export const getPostsBySearch = async (req, res) => {
    ...
    try {
        ...
        const cachedResults = await redisClient.get(searchQuery);
        if (cachedResults) {
            ...
            res.json(posts);
            await redisClient.set(searchQuery, JSON.stringify(posts));
